package com.xciel.turbines.compat.rei;

import com.xciel.turbines.Turbines;
import com.xciel.turbines.compat.rei.category.MechanicalCraftingCategory;
import com.xciel.turbines.compat.rei.category.MechanicalCraftingDisplay;
...
public class SteamTurbineREI implements REIClientPlugin {
    ...
    public static final CategoryIdentifier<MechanicalCraftingDisplay> MECHANICAL_CRAFTING =
            CategoryIdentifier.of(Turbines.rl("mechanical_crafting"));
    ...
    public void registerDisplays(DisplayRegistry registry) {
        ...
        for (RecipeHolder<CraftingRecipe> holder : recipes) {
            if (Turbines.MOD_ID.equals(holder.id().getNamespace())) {
