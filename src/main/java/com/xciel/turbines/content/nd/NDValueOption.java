...
public class NDValueOption extends ValueBoxTransform.Sided {
    ...
    public void rotate(LevelAccessor level, BlockPos pos, BlockState state, PoseStack ms) {
        Direction facing = state.getValue(NetworkDiagnoserBlock.FACING);
    ...
    public static class NDValueOptionVertical extends ValueBoxTransform.Sided {

        @Override
        protected boolean isSideActive(BlockState state, Direction side) {
            Direction facing = state.getValue(NetworkDiagnoserBlock.FACING);
            boolean alongFirst = state.getValue(NetworkDiagnoserBlock.AXIS_ALONG_FIRST_COORDINATE);
